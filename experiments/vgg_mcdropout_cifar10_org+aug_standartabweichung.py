...
def main():
    ...
    dt_string = now.strftime("std_%d_%m_%Y_%Hx%M")
    csv_filename = "uncertainties/std_metrics_cifarnet_" + dt_string + "_.csv"
    ...
    writer = SummaryWriter("vgg_mcdropout_cifar10_org+aug_standartabweichung")    # baal-serhiy/experiments/vgg_mcdropout_cifar10_org+aug_standartabweichung
