...
echo "Experiments"
cd /home/sebo742e/baal-serhiy3/experiments
...
python vgg_mcdropout_cifar10_org+aug_standartabweichung.py --epoch 50 --initial_pool 100 --learning_epoch 5 --pretrained 1
